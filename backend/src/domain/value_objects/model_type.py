...
class ModelType(str, Enum):
    ...
    WAN_2_2_API = "wan-2.2-api"
    WAN_2_2_LOCAL = "wan-2.2-local"
    ...
    def get_preferred_video_model(cls) -> "ModelType":
        """Default to real hosted generation; runtime configuration lives in Settings."""
        return cls.WAN_2_2_API
    ...
    def get_content_type(self) -> str:
        ...
        model_to_content = {
            ...
            ModelType.WAN_2_2_API: ContentType.VIDEO,
            ModelType.WAN_2_2_LOCAL: ContentType.VIDEO,
    ...
    def get_estimated_time(self) -> int:
        ...
        estimates = {
            ...
            ModelType.WAN_2_2_API: 300,
            ModelType.WAN_2_2_LOCAL: 600,
